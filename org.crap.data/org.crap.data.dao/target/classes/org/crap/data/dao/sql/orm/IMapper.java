package org.crap.data.dao.sql.orm;
...
public abstract interface IMapper {
	...
	public abstract <T> T queryUnique(String paramString, Object[] paramArrayOfObject, Class<T> paramClass);

	public abstract <T> T queryUnique(String paramString, Class<T> paramClass, Object[] paramArrayOfObject);
