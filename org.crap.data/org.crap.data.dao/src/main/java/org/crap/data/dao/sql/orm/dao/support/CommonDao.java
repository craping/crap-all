package org.crap.data.dao.sql.orm.dao.support;
...
public class CommonDao extends AbstractBaseDaoImpl implements ICommonDao {
	...
	public <T> List<T> queryEntityList(String sql, RowMapper<T> rowMapper, Object[] params, Integer offset,
			Integer limit) {
	...
	public <T> T queryUniqueResult(String sql, Class<T> paramClass, Object[] params) {
		
		return getMapper().queryUnique(sql, paramClass, params);
	}
	
	public <T> T queryUniqueResult(String sql, Class<T> paramClass) {
		
		return getMapper().queryUnique(sql, paramClass, null);
	}
	...
	public Object queryUniqueResult(String sql) {
		...
		return this.queryUniqueResult(sql, null, null);
	}
